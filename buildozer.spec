...
requirements = python3,kivy,pyjnius,plyer,pillow,sqlite3
...
android.permissions = INTERNET,RECORD_AUDIO,READ_SMS,RECEIVE_SMS,SEND_SMS,READ_PHONE_STATE,READ_CALL_LOG,CALL_PHONE,READ_CONTACTS,WRITE_EXTERNAL_STORAGE,READ_EXTERNAL_STORAGE
...
#       [app]
#       title = Niko # This is not a comment, it is part of the title.
#
#   Warning: Indented text is treated as a multiline string - i.e.
#       [app]
#       title = Niko
#          package.name = niko # This is all part of the title.
#
